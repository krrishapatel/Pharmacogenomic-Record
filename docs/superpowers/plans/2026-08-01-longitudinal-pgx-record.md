...
`tests/fixtures/23andme_build38_mentions_37.txt` — a build-38 file whose
header mentions build 37 in prose. A substring check passes this; a
positional check must reject it:

```
# This data file generated by 23andMe at: Sat Jan  1 00:00:00 2022
# Positions were previously reported on reference human assembly build 37.
# We are using reference human assembly build 38.
# rsid	chromosome	position	genotype
rs114096998	1	97078987	GG
```

`tests/fixtures/23andme_five_columns.txt` — valid header, wrong column count:

```
# This data file generated by 23andMe at: Sat Jan  1 00:00:00 2022
# We are using reference human assembly build 37 (also known as Annotation Release 104).
# rsid	chromosome	position	genotype
rs114096998	1	97544543	GG	EXTRA
rs1801268	1	97544627	CC	EXTRA
```

`tests/fixtures/23andme_edge_genotypes.txt` — hemizygous, single-dash
no-call, and indel codes alongside two usable calls:
